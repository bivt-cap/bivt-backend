define({ "api": [
  ...
  {
    "type": "post",
    "url": "/plugin/event/add",
    "title": "Add",
    "description": "<p>Add a new Event</p>",
    "name": "/plugin/event/add",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "note",
            "description": "<p>Notes about the event</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "./routes/plugins/event.js",
    "groupTitle": "Event"
  },
  {
    "type": "post",
    "url": "/plugin/event/addMember",
    "title": "Add Member",
    "description": "<p>Add a Member to an Event</p>",
    "name": "/plugin/event/addMember",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "userId",
            "description": "<p>User id to add as a member</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/plugin/event/addPhoto?circleId=??&id=??",
    "title": "Add Photo",
    "description": "<p>Add a new Photo to an Event</p>",
    "name": "/plugin/event/addPhoto",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/plugin/event/list",
    "title": "Get by period",
    "description": "<p>Get events between start and enddate</p>",
    "name": "/plugin/event/list",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "startOn",
            "description": "<p>Start Date (YYYY-MM-DD HH:MM:SS)</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
            "optional": false,
            "field": "endOn",
            "description": "<p>End Date (YYYY-MM-DD HH:MM:SS)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/plugin/event/listMembers?circleId=1&id=2",
    "title": "Get Members",
    "description": "<p>Get all member in an event</p>",
    "name": "/plugin/event/listMembers",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/plugin/event/listPhotos?circleId=1&id=2",
    "title": "Get Photos",
    "description": "<p>Get all photos in an event</p>",
    "name": "/plugin/event/listPhotos",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/plugin/event/photo",
    "title": "Photo",
    "description": "<p>Return a photo &quot;file&quot;</p>",
    "name": "/plugin/event/photo",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "delete",
    "url": "/plugin/event/remove",
    "title": "Remove",
    "description": "<p>Remove an existent event</p>",
    "name": "/plugin/event/remove",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "delete",
    "url": "/plugin/event/removeMember",
    "title": "Remove Member",
    "description": "<p>Remove a Member from an Event</p>",
    "name": "/plugin/event/removeMember",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "delete",
    "url": "/plugin/event/removePhoto",
    "title": "Remove Photo",
    "description": "<p>Remove a Photo from an Event</p>",
    "name": "/plugin/event/removePhoto",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "put",
    "url": "/plugin/event/update",
    "title": "Update",
    "description": "<p>Update an existent event</p>",
    "name": "/plugin/event/update",
    "group": "Event",
    "version": "1.0.0",
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/plugin/expenses/addBudget",
    "title": "Adds a new Budget",
    "description": "<p>Adds a Budget</p>",
    "name": "/plugin/expenses/addBudget",
    "group": "Expenses",
    "version": "1.0.0",
    "header": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "budgetName",
            "description": "<p>Name of the budget</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            "optional": false,
            "field": "budgetAmount",
            "description": "<p>Amount of the budget</p>"
          },
          {
            "group": "Parameter",
            "type": "date",
            ...
            "description": "<p>start date of the budget</p>"
          },
          {
            "group": "Parameter",
            "type": "date",
            "optional": false,
            "field": "billEndDate",
            "description": "<p>end date of the budget</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/plugin/expenses/budgets",
    "title": "List of all the budgets",
    "description": "<p>Return the list of all the available budgets</p>",
    "name": "/plugin/expenses/budgets",
    "group": "Expenses",
    "version": "1.0.0",
    "header": {
      "fields": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "bills",
            "description": "<p>List of budgets</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/plugin/expenses/removeBudget",
    "title": "Removes budget",
    "description": "<p>Removes a budget based on the budget id</p>",
    "name": "/plugin/expenses/removeBudget",
    "group": "Expenses",
    "version": "1.0.0",
    "header": {
      "fields": {
